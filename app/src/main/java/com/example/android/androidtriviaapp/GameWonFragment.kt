...
import com.example.android.androidtriviaapp.databinding.FragmentGameWonBinding
...
//        return shareIntent
        ...
        return ShareCompat.IntentBuilder(requireActivity())
            .setText(getString(R.string.share_success_text, args.numCorrect, args.numQuestions)).setType("text/plain").intent
    }
